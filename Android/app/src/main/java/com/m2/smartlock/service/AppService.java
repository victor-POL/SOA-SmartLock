...
public class AppService extends Service
{
  ...
  private MqttCallback createMqttCallback()
  {
    return new MqttCallback()
    {
      ...
      public void messageArrived(String topic, MqttMessage message)
      {
        ...
        if (Objects.equals(topic, AppMqttConstants.TOPIC_ESP_NOTIFY) && Objects.equals(value, AppMqttConstants.TOPIC_VALUE_ESP_NOTIFY_DOOR_OPEN_TIMEOUT))
        {
          showNotification();
  ...
  {
    if (actionReceived == null) return false;
